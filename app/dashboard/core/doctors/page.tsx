...
export default function DoctorsPage() {
  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600">Doctors</p>
        <h1 className="mt-2 text-3xl font-bold text-slate-900">Clinical staff</h1>
      </div>
